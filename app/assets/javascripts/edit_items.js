$(function(){
  ...
  //   $('#hidden-content').show()
  //   $('#hidden-content').attr({id: `label-box--${count}`, for: `item_images_attributes_${count}_item_image`});
    
  //   if ($(`#item_item_images_attributes_${count}__destroy`)){
  //     $(`#item_item_images_attributes_${count}__destroy`).prop('checked', false);
  //   }
  //   $(`#item_item_images_attributes_${count}__destroy`).prop('checked',true);
  //   if (count == 9) {
  //     $('.label-content').show();
  //   }
  // });